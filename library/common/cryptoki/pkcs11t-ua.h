...
#define CKM_VERSHYNA                        (CKM_VENDOR_DEFINED + 0x00420038UL)
#define CKM_SKELYA                          (CKM_VENDOR_DEFINED + 0x00420039UL)
// not used:  #define CKM_SKELYA_KEM              (CKM_VENDOR_DEFINED + 0x0042003AUL)
...
#define CKM_VERSHYNA_KEY_PAIR_GEN           (CKM_VENDOR_DEFINED + 0x00420048UL)
#define CKM_SKELYA_KEY_PAIR_GEN             (CKM_VENDOR_DEFINED + 0x00420049UL)

#define CKM_KALYNA_BLOCK128_XTS_KEY_GEN     (CKM_VENDOR_DEFINED + 0x0042004BUL)
#define CKM_KALYNA_BLOCK256_XTS_KEY_GEN     (CKM_VENDOR_DEFINED + 0x0042004CUL)
#define CKM_KALYNA_BLOCK512_XTS_KEY_GEN     (CKM_VENDOR_DEFINED + 0x0042004DUL)
#define CKM_STRUMOK_KEY_GEN                 (CKM_VENDOR_DEFINED + 0x0042004EUL)
...
#define CKK_VERSHYNA                        (CKK_VENDOR_DEFINED + 0x00420138UL)
#define CKK_SKELYA                          (CKK_VENDOR_DEFINED + 0x00420139UL)
...
typedef CK_ULONG CK_SKELYA_PARAMETER_SET_TYPE;
#define CKP_SKELYA_256_128 0x00000001UL
